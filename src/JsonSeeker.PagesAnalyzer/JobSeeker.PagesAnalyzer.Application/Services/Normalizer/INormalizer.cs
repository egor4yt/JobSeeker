...
{
    /// <summary>
    ///     Asynchronously normalizes the input text by performing predefined transformations
    /// </summary>
    ...
    /// <summary>
    ///     Synchronously normalizes the input text by performing predefined transformations
    /// </summary>
    /// <param name="text">The input text to be normalized</param>
    /// <returns>A normalized version of the input text as a string</returns>
